<div class="shb-booking-confirmation" data-testid="shb-booking-confirmation">
    <div class="shb-confirmation-card">
        <?php if ($booking['payment_status'] === 'paid') : ?>
            ...
            <p class="shb-confirm-subtitle"><?php _e('Your reservation has been successfully processed.', 'sanctuary-hotel-booking'); ?></p>
        <?php else : ?>
            ...
            <p class="shb-confirm-subtitle"><?php _e('Your booking is awaiting payment confirmation.', 'sanctuary-hotel-booking'); ?></p>
        <?php endif; ?>
    </div>
        ...
        <div class="shb-details-grid">
            ...
            <div class="shb-detail-item">
                ...
                <span class="shb-detail-value">
                    ...
                    <small><?php _e('from', 'sanctuary-hotel-booking'); ?> <?php echo esc_html(get_option('shb_check_in_time', '14:00')); ?></small>
                </span>
            </div>
            <div class="shb-detail-item">
                ...
                <span class="shb-detail-value">
                    ...
                    <small><?php _e('until', 'sanctuary-hotel-booking'); ?> <?php echo esc_html(get_option('shb_check_out_time', '11:00')); ?></small>
                </span>
            </div>
            <div class="shb-detail-item">
                ...
                <span class="shb-detail-value">
                    ...
                    <small><?php echo esc_html($booking['guests']); ?> <?php echo $booking['guests'] == 1 ? __('guest', 'sanctuary-hotel-booking') : __('guests', 'sanctuary-hotel-booking'); ?></small>
                </span>
            </div>
