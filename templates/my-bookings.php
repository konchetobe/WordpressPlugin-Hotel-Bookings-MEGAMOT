            ...
            <?php foreach ($bookings as $booking) : ?>
                <div class="shb-booking-item" data-testid="booking-item-<?php echo esc_attr($booking['booking_ref']); ?>">
                    ...
                    <div class="shb-booking-item-actions">
                        <a href="<?php echo esc_url(add_query_arg(array('shb_download_calendar' => $booking['id'], 'shb_calendar_token' => $booking['calendar_token']), home_url())); ?>" class="shb-button shb-button-outline shb-button-small">
